...
## ✅ Додаткові вимоги — виконано

### 1. Ієрархія успадкування (3 рівні)
Додано проміжний клас `NetworkDevice` між `Device` і `Router` / `Switch`.

---

### 2. Unit-тестування
Додано модульні тести (GoogleTest) у: /tests/test_network.cpp

Тестами перевіряється:

✔ коректна робота поліморфізму (`kind()`, `dynamic_cast`)  
✔ робота графа + алгоритм Dijkstra (маршрут і дистанція)  
✔ функціональність `NetworkSimulator`:  
&nbsp;&nbsp;– додавання девайсів  
&nbsp;&nbsp;– з’єднання між ними  
&nbsp;&nbsp;– побудова маршруту  
&nbsp;&nbsp;– передача пакету